...
module.exports = exports = {
  ...
  load: function (p, opts, cb, keyring) {
    ...
    meta.read(metaPath, function (err, volume) {
              ...
              function withSignature () {
                ...
                meta.write(volume.path(p), stat, function (err) {
                  ...
                  if (opts.type !== 'dir' && !opts.hidden) {
                    volume.updateIndex('+', p, {emit: opts.emit}, function (err) {
                      if (err) return cb(err);
      ...
      volume.unlink = function (p, opts, cb) {
        if (typeof opts === 'function') {
          cb = opts;
          opts = {};
        }
      ...
      volume.updateIndex = function (op, p, opts, cb) {
        if (typeof opts === 'function') {
          cb = opts;
          opts = {};
        }
      ...
      volume.import = function (p, opts, cb) {
        readdirp(p, function (err, files) {

        });
      };

      volume.mount = mount.bind(null, volume);
